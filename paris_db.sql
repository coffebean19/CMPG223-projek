...
CREATE TABLE `order` (
  ...
  CONSTRAINT `order_ibfk_1` FOREIGN KEY (`stock_id`) REFERENCES `stock` (`stock_id`)
...
CREATE TABLE `rights` (
  ...
  PRIMARY KEY (`employee_id`),
  CONSTRAINT `rights_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employee` (`employee_id`)
...
-- Dump completed on 2020-10-03 15:13:20
